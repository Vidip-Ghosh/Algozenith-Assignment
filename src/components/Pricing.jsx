...
const Pricing = () => {
  return (
    <div className="p-40 mx-24 bg-image1 bg-cover bg-no-repeat">
      <div className='flex md:flex-row flex-col justify-center items-center space-x-8'>
      <div className='flex items-center flex-col justify-center w-1/2 pt-24'>
      ...
      <div className='flex flex-col items-center rounded-2xl border border-gray-700 w-1/2'>
